...
const FeatureCard = ({ icon: Icon, title, desc, points }) => (
  <div className="group relative rounded-2xl border border-slate-200/70 dark:border-white/10 bg-white/70 dark:bg-white/5 p-6 transition-shadow hover:shadow-lg hover:shadow-blue-600/10">
...
const Logos = () => (
  <div className="mt-12 flex flex-wrap items-center justify-center gap-x-10 gap-y-4 text-slate-500 dark:text-slate-400">
    {['Stripe','Notion','Zapier','HubSpot','Salesforce','Slack'].map((name) => (
    ...
    <section id="features" className="relative">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Everything you need to win more deals</h2>
          <p className="mt-3 text-slate-600 dark:text-slate-300">A complete workflow for prospecting, outreach, and optimization — without duct tape or deliverability risks.</p>
        </div>
